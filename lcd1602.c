...
// MOJE FUNKCJE //////////////
//////////////////////////////
void LCD1602_start_screen(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("ALARM");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("MIKOLAJ TELEC");
	DELAY(2000)
	LCD1602_ClearAll();	
}	

void LCD1602_menu_screen(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("PIN: ");
}

void LCD1602_alarm_off(void)
{
	LCD1602_ClearAll();	
	LCD1602_SetCursor(0,0);
	LCD1602_Print("ALARM OFF");
	DELAY(2000)
	LCD1602_ClearAll();	
}

void LCD1602_alarm_on(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("ALARM!");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("Disable it!");
	DELAY(2000)
	LCD1602_ClearAll();	
}

void LCD1602_admin_mode_on(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("ADMIN MODE ON");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("Set ALARM PIN:");
	DELAY(2000);
	LCD1602_ClearAll();
}

void LCD1602_admin_mode_off(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("ALARM PIN set");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("ADMIN MODE OFF");
	DELAY(2000)
	LCD1602_ClearAll();
}

void LCD1602_same_pin(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("ALREADY USED");
	LCD1602_SetCursor(0,1);
...
void LCD1602_pin_not_set(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("Returning to");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("USER MODE");
	DELAY(2000)
	LCD1602_ClearAll();
}

void LCD1602_wrong_pin(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("WRONG PIN");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("Try again...");
	DELAY(2000)
	LCD1602_ClearAll();
...
void LCD1602_alarm_disarmed(void)
{
	LCD1602_SetCursor(0,0);
...
void LCD1602_blockade_on(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("BLOCKADE!!!");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("Enter ADMIN PIN:");
	DELAY(2000)
	LCD1602_ClearAll();
}

void LCD1602_blockade_off(void)
{
	LCD1602_SetCursor(0,0);
	LCD1602_Print("BLOCKADE OFF!!!");
	LCD1602_SetCursor(0,1);
	LCD1602_Print("Disable ALARM!");
	DELAY(2000)
	LCD1602_ClearAll();
}
